...
class Timbrado_cancelar extends MY_Controller {
	...
	public function set_cancelar()
	{
		...
		$this->cancelar($intMovimientoID, $strTipoReferencia);
	...
	public function cancelar($intMovimientoID, $strTipoReferencia)
	{	
		...
		$objRespuesta = $objClienteSOAP->Cancelacion_1($objCancelar);
	...
	public function get_referencia($strTipoReferencia)
	{
