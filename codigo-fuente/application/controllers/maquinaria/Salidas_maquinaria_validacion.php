...
class Salidas_maquinaria_validacion extends MY_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('maquinaria/salidas_maquinaria_validacion_model', 'movimientos');
	...
	public function index($strParametros = NULL)
	{
		...
		$this->cargar_vista('maquinaria/salidas_maquinaria_validacion', $arrDatos);
	}
	...
	public function guardar()
	{
		...
		$objSalidaValidacion = json_decode($this->input->post('salidaValidacion'));		
		$intMovimientoMaquinariaID = $objSalidaValidacion->intMovimientoMaquinariaID;
		...
		{
			$bolResultado = $this->movimientos->modificar($intMovimientoMaquinariaID, $objSalidaValidacion);
		}
		else
		{
			...
			{	
				$bolResultado = $this->movimientos->guardar($strFolio, $objSalidaValidacion); 
	...
	{	            
		...
		$pdf->strLinea1 =  utf8_decode('LISTADO DE MOVIMIENTOS DE SALIDA A VALIDACIÓN ').$strTituloRangoFechas;
		...
		$pdf->Output('salidas_maquinaria_validacion.pdf','I'); 
	}
	...
	public function get_reporte_registro($intMovimientoMaquinariaID) 
	{
		...
		$strNombreArchivo  = 'salidas_maquinaria_validacion_';
		//Agregar la primer pagina
		$pdf->AddPage();
		...
		$pdf->SetXY(80, 15);
		$pdf->ClippedCell(120, 3, utf8_decode('SALIDAS DE MAQUINARIA A VALIDACIÓN'), 0, 0, 'C', TRUE);
