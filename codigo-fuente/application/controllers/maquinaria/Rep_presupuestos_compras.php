...
class Rep_presupuestos_compras extends MY_Controller {
	...
	function __construct()
	{
		parent::__construct();
		//Cargamos el modelo
		$this->load->model('maquinaria/rep_presupuestos_compras_model', 'presupuestos');
	}
	...
	public function index($strParametros = NULL)
	{
		...
		$this->cargar_vista('maquinaria/rep_presupuestos_compras', $arrDatos);
	}
	...
	{	
		...
		$objExcel->setActiveSheetIndex(0)
			     ->setCellValue('A7', 'LISTADO DE PRESUPUESTOS DE COMPRAS DE MAQUINARIA DEL AÑO '.$intAnio);
