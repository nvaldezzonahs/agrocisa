...
class Rep_existencias_globales extends MY_Controller {
	...
	function __construct()
	{
		...
		//Cargamos el modelo
		$this->load->model('refacciones/rep_existencias_globales_model', 'existencias');
	...
	public function index($strParametros = NULL)
	{
		...
		$this->cargar_vista('refacciones/rep_existencias_globales', $arrDatos);
	}
	...
	{	            
		...
		$pdf->arrCabecera = array('SUCURSAL', utf8_decode('LOCALIZACIÓN'), 'EXISTENCIA', 
								'DISPONIBLE', 'COSTO');
		//Establece el ancho de las columnas de cabecera
		$pdf->arrAnchura = array(50, 40, 40, 40, 20);
		//Establece la alineación de las celdas de la tabla
		$pdf->arrAlineacion = array('L', 'L', 'R', 'R', 'R');*/

		$pdf->arrCabecera = array('SUCURSAL', utf8_decode('LOCALIZACIÓN'), 'EXISTENCIA', 
								'DISPONIBLE');
		//Establece el ancho de las columnas de cabecera
		$pdf->arrAnchura = array(70, 40, 40, 40, 20);
		//Establece la alineación de las celdas de la tabla
		...
		$pdf->Output('existencias_globales_refacciones.pdf','I'); 
	}
	...
	{	
        ...
        $objExcel->setActiveSheetIndex(0)
                 ...
                 ->setCellValue('D'.$intPosEncabezados, 'DISPONIBLE');
       ...
       //Definir estilo para alinear a la derecha el contenido de la celda
		...
		{	
			...
			{   
				...
				$objExcel->setActiveSheetIndex(0)
                         ...
                         ->setCellValue('D'.$intFila, $arrCol->disponible_existencia);
                         //->setCellValue('E'.$intFila, $arrCol->actual_costo);
                //Incrementar el contador por cada registro
				$intContador++;
        ...
        $this->get_pie_pagina_archivo_excel($objExcel, 'existencias_globales_refacciones.xls', 'existencias globales', $intFila);
	}
