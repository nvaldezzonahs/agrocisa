...
class Rep_presupuestos_ventas extends MY_Controller {
	...
	function __construct()
	{
		parent::__construct();
		//Cargamos el modelo
		$this->load->model('refacciones/rep_presupuestos_ventas_model', 'presupuestos');
	}
	...
	public function index($strParametros = NULL)
	{
		...
		$this->cargar_vista('refacciones/rep_presupuestos_ventas', $arrDatos);
	}
	...
	/*Método para generar un archivo XLS con el listado del presupuesto*/
	...
	{	
		...
		$otdPresupuestosVentas = $result->result();
		...
		$objExcel->setActiveSheetIndex(0)
			     ->setCellValue('A7', 'LISTADO DE PRESUPUESTOS DE VENTAS DE REFACCIONES DEL AÑO '.$intAnio);
		...
		//Si hay información
		if ($otdPresupuestosVentas)
		{	


			foreach ($otdPresupuestosVentas as $arrCol)
			{   
