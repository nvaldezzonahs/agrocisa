...
class Rep_movimientos_refacciones extends MY_Controller {
	...
	public function index($strParametros = NULL)
	{
		...
		$this->cargar_vista('refacciones/rep_movimientos_refacciones', $arrDatos);
	}
	...
	public function get_reporte() 
	{
		...
		*/
		$arrSucursalID = explode("|", $strSucursales);
