				...
				<form id="frmTrabajosForaneosServicio" method="post" action="#" class="form-horizontal" role="form" 
						...
						<div class="col-sm-2 col-md-2 col-lg-2 col-xs-12">
							<div class="form-group">
								<div class="col-md-12">
									...
									<!-- Caja de texto oculta que se utiliza para recuperar el porcentaje de ganancia del tipo de servicio-->
									<input id="txtPorcentajeTrabajosForaneos_trabajos_foraneos_servicio" 
										   name="intPorcentajeTrabajosForaneos_trabajos_foraneos_servicio"  type="hidden" 
										   value="">
									</input>
						...
						<div class="col-sm-2 col-md-2 col-lg-2 col-xs-12">
							<div class="form-group">
								<div class="col-md-12">
									...
									<input id="txtRegimenFiscalID_trabajos_foraneos_servicio" 
										   name="intRegimenFiscalID_trabajos_foraneos_servicio"  type="hidden" 
										   value="">
									</input>
					...
					<div class="row">
						<div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
											...
											<div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
												...
												<div class="row">
													...
													<div class="col-sm-4 col-md-4 col-lg-4 col-xs-12">
														<div class="form-group">
															<div class="col-md-12">
																<label for="txtObjetoImpuesto_detalles_trabajos_foraneos_servicio">Objeto de impuesto SAT</label>
															</div>
															<div class="col-md-12">
																<!-- Caja de texto oculta que se utiliza para recuperar el id del objeto de impuesto seleccionado-->
																<input id="txtObjetoImpuestoID_detalles_trabajos_foraneos_servicio" 
																	   name="intObjetoImpuestoID_detalles_trabajos_foraneos_servicio"  
																	   type="hidden" value="">
															    </input>
																<input  class="form-control" id="txtObjetoImpuesto_detalles_trabajos_foraneos_servicio" 
																		name="strObjetoImpuesto_detalles_trabajos_foraneos_servicio" type="text" 
							...
							<div id="divRetencionIsr_trabajos_foraneos_servicio"  class="col-sm-6 col-md-6 col-lg-6 col-xs-12 pull-right no-mostrar">
									<div class="form-group">
											<!--Porcentaje de ISR-->
											<div class="col-sm-6 col-md-6 col-lg-6 col-xs-12">
												<div class="form-group">
													<div class="col-md-12">
														<input id="txtPorcentajeRetencionID_trabajos_foraneos_servicio" name="intPorcentajeRetencionID_trabajos_foraneos_servicio" type="hidden" value="">
														</input>
														<label for="txtPorcentajeIsr_trabajos_foraneos_servicio">Retención de ISR %</label>
													</div>
													<div class="col-md-12">
														<input  class="form-control" id="txtPorcentajeIsr_trabajos_foraneos_servicio" 
																name="intPorcentajeIsr_trabajos_foraneos_servicio" type="text" value="" 
											...
											<div class="col-sm-6 col-md-6 col-lg-6 col-xs-12">
												<div class="form-group">
													<div class="col-md-12">
														<label for="txtImporteRetenido_trabajos_foraneos_servicio">Importe de ISR</label>
													</div>
													<div class="col-md-12">
														<input  class="form-control moneda_trabajos_foraneos_servicio" id="txtImporteRetenido_trabajos_foraneos_servicio" 
																name="intImporteRetenido_trabajos_foraneos_servicio" type="text" value="" 
	...
	<script type="text/javascript">
		...
		*********************************************************************************************************************/
		...
		var intPorcentajeRetencionBaseIDTrabajosForaneosServicio = <?php echo PORCENTAJE_ISR_BASE ?>;
		//Variable que se utiliza para asignar el id del régimen fiscal: Régimen Simplificado de Confianza
		var intRegimenFiscalIDResicoTrabajosForaneosServicio = <?php echo REGIMEN_FISCAL_RESICO ?>;
		//Variable que se utiliza para asignar el id del objeto de impuesto base
		var intObjetoImpuestoBaseIDTrabajosForaneosServicio = <?php echo OBJETOIMP_BASE ?>;
		...
		function cargar_porcentaje_isr_base_trabajos_foraneos_servicio()
		{
				...
				$.ajax({
	                 ...
	                 async: false,
	                 data: {
	                   strBusqueda: intPorcentajeRetencionBaseIDTrabajosForaneosServicio,
	                   strTipo: 'id'
	                 },
	                 success: function( data ) {
	                   if(data.row){
								...
								//Recuperar valores
								$('#txtPorcentajeRetencionID_trabajos_foraneos_servicio').val(data.row.porcentaje_retencion_id);
								$('#txtPorcentajeIsr_trabajos_foraneos_servicio').val(data.row.porcentaje);
					        }
		...
		*********************************************************************************************************************/
		...
		function nuevo_trabajos_foraneos_servicio()
		{
			...
			var arrCajasTexto  = {
									...
									rows: [	'#txtFolio_trabajos_foraneos_servicio',
											...
											'#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio',
			...
			//Hacer un llamado a la función para mostrar u ocultar retención de ISR (proveedor)
       	     mostrar_retencion_isr_trabajos_foraneos_servicio();
		}


		//Función para inicializar elementos de la orden de reparación
		function inicializar_orden_reparacion_trabajos_foraneos_servicio()
		{
			//Limpiar contenido de las siguientes cajas de texto
			$('#txtProspecto_trabajos_foraneos_servicio').val('');
	        $('#txtPorcentajeTrabajosForaneos_trabajos_foraneos_servicio').val('');
		...
		function inicializar_orden_compra_trabajos_foraneos_servicio()
		{
		    ...
		    //Limpiar contenido de las siguientes cajas de texto
            $('#txtRegimenFiscalID_trabajos_foraneos_servicio').val('');
            $('#txtPorcentajeRetencionID_trabajos_foraneos_servicio').val('');
            $('#txtPorcentajeIsr_trabajos_foraneos_servicio').val('');
            $('#txtImporteRetenido_trabajos_foraneos_servicio').val('');
		...
		function cerrar_trabajos_foraneos_servicio()
		{
			try {
				...
				//Hacer un llamado a la función para ocultar el div que contiene la barra de circulo de carga
	       		ocultar_circulo_carga_trabajos_foraneos_servicio('');
				//Cerrar modal
				...
				.bootstrapValidator({	excluded: [':disabled'],
									 	...
									 	feedbackIcons: {
									  	...
									  	fields: {
											...
											intPorcentajeIsr_trabajos_foraneos_servicio: {
											excluded: false,  // No ignorar (permite validar campo deshabilitado)
											validators: {
											    	callback: {
						                                callback: function(value, validator, $field) {
							                                    //Verificar que exista el id del porcentaje de retención ISR
							                                    if(parseInt($('#txtRegimenFiscalID_trabajos_foraneos_servicio').val()) === intRegimenFiscalIDResicoTrabajosForaneosServicio)
							                                    {
							                                    	if(value === '')
							                                    	{
							                                    		return {
											...
											intImporteRetenido_trabajos_foraneos_servicio: {
												excluded: false,  // No ignorar (permite validar campo deshabilitado)
												validators: {
											    	callback: {
						                                callback: function(value, validator, $field) {
										    ...
										    strObjetoImpuesto_detalles_trabajos_foraneos_servicio:{
										        excluded: true  // Ignorar (no valida el campo)    
										    },
		...
		function validar_detalles_trabajos_foraneos_servicios()
		{
			...
			for (var intRen = 0, objRen; objRen = objTabla.rows[intRen]; intRen++) 
			{
				...
				var intObjetoImpuestoID = objRen.cells[30].innerHTML;

				//Si no existe id del producto/servicio SAT o  id de la unidad SAT o id del objeto de impuesto SAT
				if(intProductoServicioID == '' || intUnidadID == '' || intObjetoImpuestoID  == '')
				{
				...
				else
				{
					...
					arrObjetoImpuestoID.push(intObjetoImpuestoID);
			...
			{		
		    	...
		    	strMensaje = strMensaje + 'Los siguientes <b>conceptos</b> no cuentan con código SAT, unidad SAT ni objeto de impuesto SAT:<br>';
			...
			else
			{
				...
				var intRetencionIsrProv =  parseFloat($.reemplazar($('#txtImporteRetenido_trabajos_foraneos_servicio').val(), ",", ""));
				...
				if(intRetencionIsrProv > 0)
				{
					...
					//Redondear cantidad a decimales
					intRetencionIsrProv = intRetencionIsrProv.toFixed(intNumDecimalesIvaUnitBDTrabajosForaneosServicio);
					intRetencionIsrProv = parseFloat(intRetencionIsrProv);
				}


				//Hacer un llamado a la función para guardar los datos del registro
				guardar_trabajos_foraneos_servicio(arrConceptos, arrProductoServicioID, arrUnidadID, arrObjetoImpuestoID, arrCantidades,
												   arrCostosUnitarios, arrDescuentosUnitarios, arrTasaCuotaIva,
												   arrIvasUnitarios, arrTasaCuotaIeps, arrIepsUnitarios, 
												   arrPreciosUnitarios, intRetencionIsrProv);
			}
		}
		...
		function guardar_trabajos_foraneos_servicio(arrConceptos, arrProductoServicioID, arrUnidadID, arrObjetoImpuestoID, arrCantidades,
												    arrCostosUnitarios, arrDescuentosUnitarios, arrTasaCuotaIva,
												    arrIvasUnitarios, arrTasaCuotaIeps, arrIepsUnitarios, 
												    arrPreciosUnitarios, intRetencionIsrProv)
		{
			...
			$.post('servicio/trabajos_foraneos/guardar',
					{ 
						...
						intRegimenFiscalID: $('#txtRegimenFiscalID_trabajos_foraneos_servicio').val(),
						intPorcentajeRetencionID: $('#txtPorcentajeRetencionID_trabajos_foraneos_servicio').val(),
						...
						strObjetoImpuestoID: arrObjetoImpuestoID.join('|'), 
			       ...
			       function(data) {
			            ...
			            if(data.row)
			            {
				           ...
				           if(intRetencionIsrProv > 0)
				           {
				            ...
				            $('#txtRegimenFiscalID_trabajos_foraneos_servicio').val(data.row.regimen_fiscal_id);
						    $('#txtPorcentajeRetencionID_trabajos_foraneos_servicio').val(data.row.porcentaje_retencion_id);
						    $('#txtPorcentajeIsr_trabajos_foraneos_servicio').val(data.row.porcentaje_isr);
						    $('#txtImporteRetenido_trabajos_foraneos_servicio').val(intRetencionIsrProv);
						    //Asignar formatCurrency (formato Moneda) a la caja de texto para cambiar el formato de la cantidad
					        $('#txtImporteRetenido_trabajos_foraneos_servicio').formatCurrency({ roundToDecimalPlace: intNumDecimalesMostrarTrabajosForaneosServicio });
						    ...
						    $('#txtPorcentajeTrabajosForaneos_trabajos_foraneos_servicio').val(data.row.porcentaje_trabajos_foraneos);
				            ...
				            else
				            {
				            	...
				            	$("#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio").removeAttr('disabled');
	                ...
	                if(data.row){
			            ...
			            var intRetencionIsrProv = parseFloat(data.row.importe_retenido);
             		    ...
             		    if(intRegimenFiscalIDOC == '')
             		    {
             		      ...
             		      $('#txtRegimenFiscalID_trabajos_foraneos_servicio').val(intRegimenFiscalIDProv);

             		       //Hacer un llamado a la función para mostrar u ocultar retención de ISR (proveedor)
   	    				   mostrar_retencion_isr_trabajos_foraneos_servicio('cargar_isr');
   	    				  
             		    }
             		    else
             		    {
             		    	//Asignar el id del régimen fiscal de la orden de compra (tabla ordenes_compra_refacciones)
             		    	$('#txtRegimenFiscalID_trabajos_foraneos_servicio').val(intRegimenFiscalIDOC);
		...
		function mostrar_retencion_isr_trabajos_foraneos_servicio(strTipo)
		{
			...
			if(strTipo == 'cargar_isr')
			{
				...
				//Si el id del régimen fical corresponde a  Régimen Simplificado de Confianza (RESICO)
	       	     if(parseInt( $('#txtRegimenFiscalID_trabajos_foraneos_servicio').val()) == intRegimenFiscalIDResicoTrabajosForaneosServicio)
	       	     {
	       			...
	       			cargar_porcentaje_isr_base_trabajos_foraneos_servicio();
	       	     }
            ...
            if(parseInt($('#txtRegimenFiscalID_trabajos_foraneos_servicio').val()) == intRegimenFiscalIDResicoTrabajosForaneosServicio)
            {
            	//Quitar clase no-mostrar para mostrar div que contiene la retención de ISR (proveedor)
			  	$('#divRetencionIsr_trabajos_foraneos_servicio').removeClass("no-mostrar");

            }
            else
            {
            	//Agregar clase no-mostrar para ocultar div que contiene la retención de ISR (proveedor)
			    $('#divRetencionIsr_trabajos_foraneos_servicio').addClass("no-mostrar");
            }
		...
		function cargar_objeto_impuesto_base_trabajos_foraneos_servicio()
		{
			//Hacer un llamado al método del controlador para regresar los datos del registro
			$.ajax({
			        ...
			        async: false,
			        data: {
			        	strBusqueda:intObjetoImpuestoBaseIDTrabajosForaneosServicio,
			       		strTipo: 'id'
			        },
			        success: function (data) {
			        	...
			        	{
			        		//Recuperar valores
				            $('#txtObjetoImpuestoID_detalles_trabajos_foraneos_servicio').val(data.row.objeto_impuesto_id);
				            $('#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio').val(data.row.codigo+' - '+data.row.descripcion);
		...
		*********************************************************************************************************************/
		...
		function inicializar_concepto_detalles_trabajos_foraneos_servicio()
		{
		    ...
		    $('#txtObjetoImpuestoID_detalles_trabajos_foraneos_servicio').val('');
		    $('#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio').val('');
		...
		function lista_detalles_trabajos_foraneos_servicio(tipoAccion, estatus, objDetalles) 
		{
			...
			if(estatus == '' || (estatus == 'ACTIVO' && tipoAccion == 'Editar'))
			{
	            ...
	            for (var intCon in objDetalles) 
	            {
					...
					var objCeldaObjetoImpuestoID = objRenglon.insertCell(30);
					var objCeldaObjetoImpuesto = objRenglon.insertCell(31);
					...
					var intUnidadID = '';
					var strUnidad = '';
					var intObjetoImpuestoID = '';
					var strObjetoImpuesto = '';
					...
					else
					{
						...
						intObjetoImpuestoID = objDetalles[intCon].objeto_impuesto_id;
						strObjetoImpuesto = objDetalles[intCon].objeto_impuesto;
					...
					objCeldaObjetoImpuestoID.setAttribute('class', 'no-mostrar');
					objCeldaObjetoImpuestoID.innerHTML = intObjetoImpuestoID;
		...
		function agregar_renglon_detalles_trabajos_foraneos_servicio()
		{
			...
			var intObjetoImpuestoID = $('#txtObjetoImpuestoID_detalles_trabajos_foraneos_servicio').val();
			var strObjetoImpuesto = $('#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio').val();
			...
			if (intRenglon != '' )
			{
				...
				else if ((intObjetoImpuestoID == '' || strObjetoImpuesto == '' ) && intCantidad != '')
				{
					//Enfocar caja de texto
					$('#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio').focus();
				}
				else if (intCantidad == '')
				{
					//Enfocar caja de texto
				...
				else
				{
					...
					objTabla.rows.namedItem(intRenglon).cells[30].innerHTML = intObjetoImpuestoID;
					objTabla.rows.namedItem(intRenglon).cells[31].innerHTML = strObjetoImpuesto;
		...
		{
			//Variable que se utiliza para asignar el porcentaje de ganancia
			var intPorcentajeGanancia = objRenglon.parentNode.parentNode.cells[12].innerHTML;
		
			//Si no existe el id del registro
			if($('#txtTrabajoForaneoID_trabajos_foraneos_servicio').val() == '')
			{
				//Asignar el porcentaje de ganancia del servicio
				intPorcentajeGanancia = $('#txtPorcentajeTrabajosForaneos_trabajos_foraneos_servicio').val();
			...
			$('#txtPorcentajeGanancia_detalles_trabajos_foraneos_servicio').val(intPorcentajeGanancia);
			...
			$('#txtObjetoImpuestoID_detalles_trabajos_foraneos_servicio').val(objRenglon.parentNode.parentNode.cells[30].innerHTML);
			$('#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio').val(objRenglon.parentNode.parentNode.cells[31].innerHTML);

			//Si no existe id del objeto de impuesto SAT
			if($('#txtObjetoImpuestoID_detalles_trabajos_foraneos_servicio').val() == '')
			{
				//Hacer un llamado a la función para cargar el uso de objeto de impuesto base
				cargar_objeto_impuesto_base_trabajos_foraneos_servicio();
			}
		...
		function calcular_totales_detalles_trabajos_foraneos_servicio()
		{
			...
			var intAcumSubtotalAnterior = $('#acumSubtotal_detalles_trabajos_foraneos_servicio').html();
			...
			//Si no existe id del trabajo foráneo, significa que es un nuevo registro
			if($('#txtTrabajoForaneoID_trabajos_foraneos_servicio').val() == '' && intContReg == 1)
			{
			...
			if(intAcumSubtotalAnterior != intAcumSubtotal && intAcumSubtotalAnterior != '')
			{
				...
				calcular_isr_trabajos_foraneos_servicio();
			}

		}

		//Función que se utiliza para calcular la retención de ISR (proveedor)
		function calcular_isr_trabajos_foraneos_servicio()
		{
			 ...
			 //Si el id del régimen fical corresponde a  Régimen Simplificado de Confianza (RESICO)
				...
				intAcumSubtotal =  $.reemplazar($('#acumSubtotal_detalles_trabajos_foraneos_servicio').html(), "$", "");
				intAcumSubtotal =  $.reemplazar(intAcumSubtotal, ",", "");

				//Si existe porcentaje de ISR (proveedor)
				if($('#txtPorcentajeIsr_trabajos_foraneos_servicio').val() != '' && intAcumSubtotal > 0 )
				{
					//Variable que se utiliza para asignar el porcentaje de retención ISR
					var intPorcentajeRetencionIsr = parseFloat($('#txtPorcentajeIsr_trabajos_foraneos_servicio').val());

					//Calcular retención de ISR 
					intImporteRetenido = parseFloat(intAcumSubtotal * intPorcentajeRetencionIsr);
					//Redondear cantidad a decimales
					intImporteRetenido = intImporteRetenido.toFixed(intNumDecimalesMostrarTrabajosForaneosServicio);
					intImporteRetenido = parseFloat(intImporteRetenido);
				}

				//Convertir cantidad a formato moneda
				intImporteRetenido = formatMoney(intImporteRetenido, intNumDecimalesMostrarTrabajosForaneosServicio, '');

				//Asignar importe retenido 
				$('#txtImporteRetenido_trabajos_foraneos_servicio').val(intImporteRetenido);
		...
		$(document).ready(function() 
		{
			...
			*********************************************************************************************************************/
        	...
        	$('#txtPorcentajeIsr_trabajos_foraneos_servicio').numeric();
        	$('#txtImporteRetenido_trabajos_foraneos_servicio').numeric();
	        ...
	        $('#txtOrdenReparacion_trabajos_foraneos_servicio').autocomplete({
	            source: function( request, response ) {
	               ...
	               inicializar_orden_reparacion_trabajos_foraneos_servicio();
	               $.ajax({
	           ...
	           select: function( event, ui ) {
	              ...
	              $('#txtPorcentajeTrabajosForaneos_trabajos_foraneos_servicio').val(ui.item.porcentaje_trabajos_foraneos);
	           },
	           open: function() {
	        ...
	        $('#txtPorcentajeIsr_trabajos_foraneos_servicio').autocomplete({
	            source: function( request, response ) {
	               //Limpiar caja de texto que hace referencia al id del registro 
	               $('#txtPorcentajeRetencionID_trabajos_foraneos_servicio').val('');
	               $.ajax({
	           ...
	           select: function( event, ui ) {
	             //Asignar id del registro seleccionado
	             $('#txtPorcentajeRetencionID_trabajos_foraneos_servicio').val(ui.item.data);
	           },
	           open: function() {
	               $( this ).removeClass( "ui-corner-all" ).addClass( "ui-corner-top" );
	             },
	        ...
	        $('#txtPorcentajeIsr_trabajos_foraneos_servicio').focusout(function(e){
	            //Si no existe id de la tasa o cuota
	            if($('#txtPorcentajeRetencionID_trabajos_foraneos_servicio').val() == '' ||
	               $('#txtPorcentajeIsr_trabajos_foraneos_servicio').val() == '')
	            { 
	               //Limpiar contenido de las siguientes cajas de texto
	               $('#txtPorcentajeRetencionID_trabajos_foraneos_servicio').val('');
	        ...
	        $('#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio').autocomplete({
	              source: function( request, response ) {
	              	 //Limpiar caja de texto que hace referencia al id del registro 
	                 $('#txtObjetoImpuestoID_detalles_trabajos_foraneos_servicio').val('');
	                 $.ajax({
	             ...
	             select: function( event, ui ) {
	               //Asignar id del registro seleccionado
	               $('#txtObjetoImpuestoID_detalles_trabajos_foraneos_servicio').val(ui.item.data);
	             },
	             open: function() {
	                 $( this ).removeClass( "ui-corner-all" ).addClass( "ui-corner-top" );
	               },
	        ...
	        $('#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio').focusout(function(e){
			...
			$('#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio').on('keypress', function (e) {
		        if(e.which === 13 )
		        {
		            //Si no existe objeto de impuesto SAT 
		            if($('#txtObjetoImpuestoID_detalles_trabajos_foraneos_servicio').val() == '' || $('#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio').val() == '')
			   	    {
			   	   		//Enfocar caja de texto
					    $('#txtObjetoImpuesto_detalles_trabajos_foraneos_servicio').focus();
			   	    }
