...
class Maquinaria_listas_precios_model extends CI_model {
	...
	public function modificar(stdClass $objListaPrecios)
	{
		...
		$this->db->where('maquinaria_lista_precio_id', $objListaPrecios->intMaquinariaListaPrecioID);
		$this->db->limit(1);
