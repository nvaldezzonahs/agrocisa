...
class Salidas_maquinaria_demostracion_model extends CI_model {

	//Método para guardar un registro nuevo
	public function guardar($strFolio, $objSalidaDemostracion)
	{
		...
		$arrDatos = array('sucursal_id' => $this->session->userdata('sucursal_id'),
						  'tipo_movimiento' => mb_strtoupper($objSalidaDemostracion->strTipoMovimiento),
						  'folio' => $strFolioConsecutivo, 
						  'fecha' => mb_strtoupper($objSalidaDemostracion->strFecha),
						  'referencia_id'=> $objSalidaDemostracion->intReferenciaID,  
						  'prospecto_id'=> $objSalidaDemostracion->intReferenciaID,
						  'vendedor_id' => $objSalidaDemostracion->intVendedorID,
						  'chofer_id' => $objSalidaDemostracion->intChoferID, 
						  'vehiculo_id' => $objSalidaDemostracion->intVehiculoID, 
						  'observaciones' => mb_strtoupper($objSalidaDemostracion->strObservaciones),
		...
		$this->guardar_maquinaria_detalles($intMovimientoMaquinariaID, $objSalidaDemostracion->arrMaquinarias);

		//Hacer un llamado para actualizar el campo salida_id en la tabla maquinaria_inventario
		$this->actualizar_maquinaria_inventario($intMovimientoMaquinariaID, $objSalidaDemostracion->arrMaquinarias);
	...
	public function modificar($intMovimientoMaquinariaID, $objSalidaDemostracion)
	{
		//Iniciamos la transacción
		$this->db->trans_begin();
		//Asignar datos al array
	...
	{	
		...
		$this->db->where('MM.tipo_movimiento', SALIDA_MAQUINARIA_DEMOSTRACION);
