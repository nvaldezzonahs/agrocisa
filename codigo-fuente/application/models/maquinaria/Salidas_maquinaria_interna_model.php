...
class Salidas_maquinaria_interna_model extends CI_model {
	...
	public function buscar_detalles($intMovimientoMaquinariaID)
	{
		...
		$this->db->join('maquinaria_inventario AS MI', 'MI.serie = MMD.serie AND MI.maquinaria_descripcion_id = MMD.maquinaria_descripcion_id AND MI.codigo = MMD.codigo AND MI.sucursal_id = MM.sucursal_id','inner');
