...
class Porcentaje_retencion_isr_model extends CI_model {
	...
	public function guardar(stdClass $objPorcentajeRetencion)
	{
		...
		return $this->db->insert('porcentaje_retencion_isr', $arrDatos);
	}
	...
	public function modificar(stdClass $objPorcentajeRetencion)
	{
		...
		return $this->db->update('porcentaje_retencion_isr', $arrDatos);
	}
	...
	public function buscar($intPorcentajeRetencionID = NULL,  $strBusqueda = NULL)
	{
		...
		$this->db->from('porcentaje_retencion_isr');
	...
	{
		$this->db->select('porcentaje_retencion_id, porcentaje');
       $this->db->from('porcentaje_retencion_isr');
	    $this->db->where('estatus', 'ACTIVO');
        $this->db->where("(porcentaje LIKE '%$strDescripcion%')");  
        $this->db->order_by("porcentaje",'ASC');  
