...
;(function($) {
  'use strict';
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      popups = ($w.data('bPopup') || 0) + 1, id = o.contentContainer + '__',fixedVPos = o.position[1] !== 'auto', fixedHPos = o.position[0] !== 'auto', fixedPosStyle = o.positionStyle === 'fixed', height = $popup.outerHeight(true), width = $popup.outerWidth(true);
    ...
    function open(){
      // MODAL OVERLAY
            if (o.modal) {
                ...
                .css({backgroundColor: o.modalColor, position: 'absolute', top: 0, right:0, bottom:0, left: 0, opacity: 0, zIndex: o.zIndex + popups})
                .appendTo(o.appendTo)
